...
<head>
    ...
    <title>Códigos de Recuperación - GesVitalPro</title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-800">Códigos de Recuperación</h2>
                <p class="text-gray-600 mt-2">Guarde estos códigos en un lugar seguro</p>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            Estos códigos de recuperación solo se mostrarán una vez. Guárdelos en un lugar seguro y accesible.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    @foreach($recoveryCodes as $code)
                        <div class="flex items-center">
                            <code class="font-mono text-sm flex-1">{{ $code }}</code>
